        ...
        try {
            ...
            if (cloudData) {
                ...
                if (prevEventsStr !== newEventsStr || prevNotesStr !== newNotesStr) {
                    ...
                    renderCalendar();
                    console.log("🔄 Tablero auto-refrescado por cambios en la nube.");
                }
            }
        } catch (e) {
...
function openActivityHistoryModal() {
    ...
    let htmlContent = `
        <div class="activity-history-container" style="max-height: 480px; overflow-y: auto; font-family: sans-serif;">
